...
{   
    ...
    BTNode* left1 =tree1->left;
    BTNode* right1 = tree1->right;
    BTNode* left2 = tree2->left;
    BTNode* right2 = tree2->right;
   ...
   int r = identical(right1, right2);
   int l = identical(left1, left2);
    if(r==1 && l == 1){
        return 1;
    }
    else {
